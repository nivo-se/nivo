...
export const investorTranslations = {
  ...
  sv: {
    ...
    execSummaryWhatPara1:
      "I samarbete med en liten grupp investerare förvärvas och förbättras nordiska företag på lång sikt.",
    execSummaryWhatPara2:
    ...
    execSummaryModelSentence:
      "Vi arbetar enligt en enkel modell: förvärvar lönsamma bolag, förbättrar marginaler genom traditionella prestationsverktyg med AI-accelererad exekvering, omvandlar till kassaflöde och återinvesterar över tid.",
    shortVersionBullet1: "20–25 % IRR",
    shortVersionBullet2: "4–5x MOIC",
    shortVersionBullet3:
    ...
    sourcingEngine:
      "Vi använder en proprietär sökmotor som analyserar det svenska företagsuniversumet och levererar förrankade mål med finansiella och operativa signaler — vilket gör att vi kan närma oss företag med strukturerad intelligens som de flesta riskkapitalbolag saknar.",
    ...
    execSummaryModelSentenceLong: "Förvärva lönsamma bolag, förbättra marginaler via verktygslåda och AI-accelererade arbetsflöden, omvandla till kassaflöde, återinvestera.",
    whyNowTextLong:
    ...
    sourcingEngineLong:
      "Datadriven sökmotor söker i det svenska företagsuniversumet och levererar förrankade mål med finansiella och operativa signaler. Tidigare identifiering, bättre förberedelse och tydligare operativ förståelse före första kontakten—strukturerad intelligens som de flesta riskkapitalbolag saknar.",
    ...
    sourcingEdgeMainLong:
      "Egen motor söker svenska bolag (SEK 50–200 mkr), poängsätter utifrån ekonomi och marginal-signaler, rankar mål. Djupare analys—produkter, prissättning, operativa luckor—före första kontakten. Resultat: tidigare identifiering, bättre förberedelse, starkare positionering. De flesta riskkapitalbolag förlitar sig på mäklarflöden.",
